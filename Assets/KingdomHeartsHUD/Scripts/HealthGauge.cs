...
public class HealthGauge : MonoBehaviour
{
    ...
    [Range(0, 100)] // Cambiado el rango a 0-100
    ...
    private void UpdateCircularSection()
    {
        ...
        // Ajusta fillPercentage para trabajar con el rango 0-100
        float normalizedFillPercentage = fillPercentage / 100f;
        innerCircularSection.fillAmount = Mathf.Lerp(0f, outerCircularSection.fillAmount, (normalizedFillPercentage / circlePercentage));
    ...
    private void UpdateLinearSection()
    {
        ...
        // Ajusta fillPercentage para trabajar con el rango 0-100
        float normalizedFillPercentage = fillPercentage / 100f;
        innerLinearSection.fillAmount = Mathf.Lerp(0, 1, ((normalizedFillPercentage - circlePercentage) / (1 - circlePercentage)));

        linearCap.enabled = outerLinearSection.rectTransform.sizeDelta.x > 0;
    }
    ...
    {
        // Normaliza el valor para trabajar con el rango 0-100
        this.fillPercentage = Mathf.Clamp(newValue, 0, 100);
    }
